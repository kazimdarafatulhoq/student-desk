        ...
        Document.Create(container =>
        {
            container.Page(page =>
            {
                ...
                page.Header().Column(col =>
                {
                    ...
                    col.Item().AlignCenter().Text("MONEY RECEIPT").SemiBold().FontSize(12);
        ...
        Document.Create(container =>
        {
            container.Page(page =>
            {
                ...
                page.Header().Column(col =>
                {
                    ...
                    col.Item().AlignCenter().Text("STUDENT FINANCIAL LEDGER STATEMENT").SemiBold();
            ...
            foreach (var card in cards)
            {
                container.Page(page =>
                {
                    ...
                    page.Header().Column(col =>
                    {
                        ...
                        col.Item().AlignCenter().Text("ADMIT CARD").SemiBold().FontSize(13);
                    ...
                    page.Content().PaddingTop(10).Column(col =>
                    {
                        ...
                        col.Item().PaddingTop(12).AlignCenter().Text($"* {card.BarcodeValue} *").FontFamily(Fonts.CourierNew).FontSize(12);
